...
const Footer: React.FC = () => {
  return (
    <footer className="w-full bg-[#202020] text-[#dbdbdb] shadow py-8 fixed bottom-0 left-0 z-50">
      <div className="w-full flex items-center justify-between md:px-6 lg:px-60 text-xs">
